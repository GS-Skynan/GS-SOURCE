...
# 322 "mcc_generated_files/uart/src/../../system/../uart/uart1.h"
...
# 347 "mcc_generated_files/uart/src/../../system/../uart/uart1.h"
...
# 208 "mcc_generated_files/uart/src/../uart2.h"
...
# 241 "mcc_generated_files/uart/src/../uart2.h"
_Bool UART2_IsRxReady(void);
# 250 "mcc_generated_files/uart/src/../uart2.h"
_Bool UART2_IsTxReady(void);
# 259 "mcc_generated_files/uart/src/../uart2.h"
_Bool UART2_IsTxDone(void);
# 269 "mcc_generated_files/uart/src/../uart2.h"
size_t UART2_ErrorGet(void);
# 279 "mcc_generated_files/uart/src/../uart2.h"
uint8_t UART2_Read(void);
# 289 "mcc_generated_files/uart/src/../uart2.h"
...
# 322 "mcc_generated_files/uart/src/../uart2.h"
...
# 347 "mcc_generated_files/uart/src/../uart2.h"
...
static volatile uint8_t uart2TxBuffer[(16U)];
static volatile uint8_t uart2TxBufferRemaining;

static volatile uint8_t uart2RxHead = 0;
static volatile uint8_t uart2RxTail = 0;
static volatile uint8_t uart2RxBuffer[(16U)];





static volatile uart2_status_t uart2RxStatusBuffer[(16U)];
static volatile uint8_t uart2RxCount;
...
static void (*UART2_TxCompleteInterruptHandler)(void) = ((void*)0);
void (*UART2_RxInterruptHandler)(void);
static void (*UART2_RxCompleteInterruptHandler)(void) = ((void*)0);
...
size_t UART2_ErrorGet(void)
{
    uart2RxLastError.status = uart2RxStatusBuffer[(uart2RxTail) & ((16U) - 1U)].status;
...
uint8_t UART2_Read(void)
{
    ...
    tempRxTail = (uart2RxTail + 1U) & ((16U) - 1U);
...
void __attribute__((picinterrupt(("irq(64), base(12296)")))) UART2_Receive_Vector_ISR(void)
{
    UART2_ReceiveISR();
}
...
void UART2_ReceiveISR(void)
{
 ...
 uint8_t tempRxHead;
    ...
    {
        uart2RxStatusBuffer[uart2RxHead].perr = 1;
    ...
    tempRxHead = (uart2RxHead + 1U) & ((16U) - 1U);
  ...
  uart2RxCount++;
    ...
    if(((void*)0) != UART2_RxCompleteInterruptHandler)
    {
...
void UART2_Write(uint8_t txData)
{
    ...
    else if(0U < uart2TxBufferRemaining)
    {
       uart2TxBuffer[uart2TxHead] = txData;
       tempTxHead = (uart2TxHead + 1U) & ((16U) - 1U);
...
void __attribute__((picinterrupt(("irq(65), base(12296)")))) UART2_Transmit_Vector_ISR(void)
{
    UART2_TransmitISR();
}
...
void UART2_TransmitISR(void)
{
    ...
    if(sizeof(uart2TxBuffer) > uart2TxBufferRemaining)
    {
       ...
       tempTxTail = (uart2TxTail + 1U) & ((16U) - 1U);
    ...
    if(((void*)0) != UART2_TxCompleteInterruptHandler)
    {
