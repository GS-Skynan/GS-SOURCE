# 1 "mcc_generated_files/bootloader/src/bl_boot_verify.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/bootloader/src/bl_boot_verify.c" 2
# 33 "mcc_generated_files/bootloader/src/bl_boot_verify.c"
...
# 34 "mcc_generated_files/bootloader/src/bl_boot_verify.c" 2
# 1 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\include\\c99/stdbool.h" 1 3
# 35 "mcc_generated_files/bootloader/src/bl_boot_verify.c" 2
# 1 "mcc_generated_files/bootloader/src/../bl_bootload.h" 1
# 37 "mcc_generated_files/bootloader/src/../bl_bootload.h"
...
# 36 "mcc_generated_files/bootloader/src/bl_boot_verify.c" 2
...
_Bool BL_bootVerify(void)
{
    ...
    flash_address_t address = (0x3000);

    if (FLASH_Read(address) != (0xFFU))
    {
        retVal = 1;
    }
    else
