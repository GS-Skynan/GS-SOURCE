...
FINAL_IMAGE=${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
nbproject/$(CND_CONF).$(IMAGE_TYPE):   nbproject/Makefile-${CND_CONF}.mk    
		@cmd /C "gnuecho -n "-mcpu=$(MP_PROCESSOR_OPTION) $(MP_EXTRA_LD_PRE) -Wl,-Map=${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.map " > nbproject/default.debug"
	...
	@cmd /C "gnuecho -n "-I\"Middlewares/QUEUE\" -I\"Applications/version_read\" -I\"Middlewares/Arithmetic\" -I\"Applications/USBCom_APP\" -I\"Applications/App_config\" -mwarn=-3 " >> nbproject/default.debug"
	...
	@cmd /C "gnuecho -n "-o ${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} " >> nbproject/default.debug"
	...
	@cmd /C "gnuecho -n "${OBJECTDIR}/mcc_generated_files/timer/src/tmr2.p1 ${OBJECTDIR}/mcc_generated_files/timer/src/tmr1.p1 ${OBJECTDIR}/mcc_generated_files/timer/src/tmr4.p1 ${OBJECTDIR}/mcc_generated_files/uart/src/uart1.p1 ${OBJECTDIR}/main.p1 " >> nbproject/default.debug"

	
else
nbproject/$(CND_CONF).$(IMAGE_TYPE):   nbproject/Makefile-${CND_CONF}.mk   
		@cmd /C "gnuecho -n "-mcpu=$(MP_PROCESSOR_OPTION) $(MP_EXTRA_LD_PRE) -Wl,-Map=${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.map " > nbproject/default.production"
	...
	@cmd /C "gnuecho -n "-I\"Middlewares/QUEUE\" -I\"Applications/version_read\" -I\"Middlewares/Arithmetic\" -I\"Applications/USBCom_APP\" -I\"Applications/App_config\" -mwarn=-3 " >> nbproject/default.production"
	...
	@cmd /C "gnuecho -n "-o ${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} " >> nbproject/default.production"
	@cmd /C "gnuecho -n "${OBJECTDIR}/Applications/Bootloader/Bootloader.p1 ${OBJECTDIR}/Applications/CurrentRead_APP/readcurrent.p1 ${OBJECTDIR}/Applications/Dimming_APP/dimming.p1 ${OBJECTDIR}/Applications/InProtected_APP/inprotectedapp.p1 ${OBJECTDIR}/Applications/LightsOff_APP/closeled.p1 ${OBJECTDIR}/Applications/OutProtected_APP/out_protected.p1 ${OBJECTDIR}/Applications/TempProtected_APP/temp_protected.p1 ${OBJECTDIR}/Applications/Ticktime_APP/ticktime.p1 ${OBJECTDIR}/Applications/USBCom_APP/usbcom.p1 ${OBJECTDIR}/Applications/version_read/version_task.p1 " >> nbproject/default.production"
	@cmd /C "gnuecho -n "${OBJECTDIR}/DriverLayer/ADC/adc_driver.p1 ${OBJECTDIR}/DriverLayer/EEPROM/EEPROM_driver.p1 ${OBJECTDIR}/DriverLayer/GPIO/GPIO_driver.p1 ${OBJECTDIR}/DriverLayer/NFC/nfc.p1 ${OBJECTDIR}/DriverLayer/PWM/pwm_driver.p1 ${OBJECTDIR}/DriverLayer/RS485/RS485_DATA.p1 ${OBJECTDIR}/Middlewares/Arithmetic/arithmetic.p1 ${OBJECTDIR}/Middlewares/CRC/crc.p1 ${OBJECTDIR}/Middlewares/PID/pid_controller.p1 ${OBJECTDIR}/Middlewares/QUEUE/queue.p1 ${OBJECTDIR}/mcc_generated_files/adc/src/adc.p1 ${OBJECTDIR}/mcc_generated_files/fvr/src/fvr.p1 " >> nbproject/default.production"
	@cmd /C "gnuecho -n "${OBJECTDIR}/mcc_generated_files/i2c_host/src/i2c1.p1 ${OBJECTDIR}/mcc_generated_files/nvm/src/nvm.p1 ${OBJECTDIR}/mcc_generated_files/pwm/src/pwm2_16bit.p1 ${OBJECTDIR}/mcc_generated_files/pwm/src/pwm3_16bit.p1 ${OBJECTDIR}/mcc_generated_files/system/src/clock.p1 ${OBJECTDIR}/mcc_generated_files/system/src/interrupt.p1 ${OBJECTDIR}/mcc_generated_files/system/src/config_bits.p1 ${OBJECTDIR}/mcc_generated_files/system/src/system.p1 ${OBJECTDIR}/mcc_generated_files/system/src/pins.p1 ${OBJECTDIR}/mcc_generated_files/timer/src/tmr0.p1 " >> nbproject/default.production"
	@cmd /C "gnuecho -n "${OBJECTDIR}/mcc_generated_files/timer/src/tmr2.p1 ${OBJECTDIR}/mcc_generated_files/timer/src/tmr1.p1 ${OBJECTDIR}/mcc_generated_files/timer/src/tmr4.p1 ${OBJECTDIR}/mcc_generated_files/uart/src/uart1.p1 ${OBJECTDIR}/main.p1 " >> nbproject/default.production"
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES} nbproject/$(CND_CONF).$(IMAGE_TYPE)  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC}  @nbproject/$(CND_CONF).$(IMAGE_TYPE) 
	@${RM} ${DISTDIR}/GS-S2CH-02-V0.10.${IMAGE_TYPE}.hex 
