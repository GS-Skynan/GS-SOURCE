...
# 80 "./mcc_generated_files/pin_manager.h"
...
# 101 "./mcc_generated_files/interrupt_manager.h"
...
# 144 "./mcc_generated_files/i2c1_master.h"
void I2C1_SetBuffer(void *buffer, size_t bufferSize);
# 155 "./mcc_generated_files/i2c1_master.h"
...
# 101 "./mcc_generated_files/pwm6.h"
 void PWM6_Initialize(void);
# 128 "./mcc_generated_files/pwm6.h"
 void PWM6_LoadDutyValue(uint16_t dutyValue);
# 60 "./mcc_generated_files/mcc.h" 2
# 1 "./mcc_generated_files/pwm7.h" 1
# 101 "./mcc_generated_files/pwm7.h"
 void PWM7_Initialize(void);
# 128 "./mcc_generated_files/pwm7.h"
 void PWM7_LoadDutyValue(uint16_t dutyValue);
# 61 "./mcc_generated_files/mcc.h" 2
# 1 "./mcc_generated_files/adcc.h" 1
# 71 "./mcc_generated_files/adcc.h"
typedef uint16_t adc_result_t;
# 85 "./mcc_generated_files/adcc.h"
typedef enum
{
    channel_Iout = 0x0D,
    channel_Temp = 0x15,
...
# 374 "./mcc_generated_files/tmr2.h"
void TMR2_ModeSet(TMR2_HLT_MODE mode);
# 409 "./mcc_generated_files/tmr2.h"
void TMR2_ExtResetSourceSet(TMR2_HLT_EXT_RESET_SOURCE reset);
# 438 "./mcc_generated_files/tmr2.h"
void TMR2_Start(void);
# 467 "./mcc_generated_files/tmr2.h"
void TMR2_StartTimer(void);
# 499 "./mcc_generated_files/tmr2.h"
void TMR2_Stop(void);
# 531 "./mcc_generated_files/tmr2.h"
void TMR2_StopTimer(void);
# 566 "./mcc_generated_files/tmr2.h"
uint8_t TMR2_Counter8BitGet(void);
# 601 "./mcc_generated_files/tmr2.h"
uint8_t TMR2_ReadTimer(void);
# 640 "./mcc_generated_files/tmr2.h"
...
# 821 "./mcc_generated_files/tmr2.h"
...
# 1 "./Application/led_close/led_close_task.h" 1
...
# 21 "main.c" 2
# 1 "./Application/led_dimming/led_dimming_task.h" 1
...
# 22 "main.c" 2
# 1 "./Application/led_protect/protect_task.h" 1
...
# 23 "main.c" 2
# 1 "./Application/nfc_read/nfc_read_task.h" 1
...
# 24 "main.c" 2
# 1 "./Application/rs485_receive/rs485_task.h" 1
...
# 25 "main.c" 2
# 1 "./Application/version_read/version_task.h" 1




# 1 "./Application/version_read/../../mcc_generated_files/examples/i2c_simple_example.h" 1
# 33 "./Application/version_read/../../mcc_generated_files/examples/i2c_simple_example.h"
void I2CSIMPLE_example(void);
# 6 "./Application/version_read/version_task.h" 2
# 1 "./Application/version_read/../../mcc_generated_files/examples/i2c1_master_example.h" 1
# 55 "./Application/version_read/../../mcc_generated_files/examples/i2c1_master_example.h"
...
# 7 "./Application/version_read/version_task.h" 2
...
# 26 "main.c" 2
# 1 "./Drivers/GPIO/GPIO_driver.h" 1
# 34 "./Drivers/GPIO/GPIO_driver.h"
typedef enum {
    L6562_CHANNEL1 = 0x01,
    L6562_CHANNEL2 = 0x02,
} eL6562_CHANNEL;
...
typedef struct
{
    _Bool run; // 任务运行标志位，1表示需要执行，0表示不需要执行
...
static tTaskComps g_taskComps[] = {
    {0 //运行任务的标志, 20 // 短路保护任务间隔，每10ms个单位时间执行一次, 20 // 短路保护任务间隔，每10ms个单位时间执行一次, ShortCircuitProtect},
    {0 //运行任务的标志, 30 // 开路保护任务间隔，每20ms个单位时间执行一次, 30 // 开路保护任务间隔，每20ms个单位时间执行一次, OpenCircuitProtect},
    {0 //运行任务的标志, 40 // 温度保护任务间隔，每30ms个单位时间执行一次, 40 // 温度保护任务间隔，每30ms个单位时间执行一次, TempProtect},
    {0 //运行任务的标志, 50 // 电压输入保护任务间隔，每40ms个单位时间执行一次, 50 // 电压输入保护任务间隔，每40ms个单位时间执行一次, VoltageInputProtection},
    {0 //运行任务的标志, 100 // RS485消息处理任务间隔，每100ms个单位时间执行一次, 100 // RS485消息处理任务间隔，每100ms个单位时间执行一次, HandleRS485Message},
    {0 //运行任务的标志, 120 // 调光动作任务间隔，每120ms个单位时间执行一次, 120 // 调光动作任务间隔，每120ms个单位时间执行一次, DimmingAction},
};
...
{
    for (uint8_t i = 0; i < (sizeof(g_taskComps) / sizeof(g_taskComps[0])); i++)
    {
