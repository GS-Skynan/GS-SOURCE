...
# 1 "mcc_generated_files/../Application/nfc_read/nfc_read_task.h" 1
...
# 1 "mcc_generated_files/../Application/led_protect/protect_task.h" 1
...
# 1 "mcc_generated_files/../Drivers/GPIO/GPIO_driver.h" 1
# 34 "mcc_generated_files/../Drivers/GPIO/GPIO_driver.h"
typedef enum {
    L6562_CHANNEL1 = 0x01,
    L6562_CHANNEL2 = 0x02,
} eL6562_CHANNEL;
...
# 1 "mcc_generated_files/../Application/led_dimming/led_dimming_task.h" 1
...
uint8_t Rx_Buffer_ISR[40 //数据缓存的长度];
uint8_t Rx_Length = 0;
...
_Bool g_bRs485Flag = 0;
_Bool g_bInputActiveTime = 0;


_Bool g_bShortFlag = 0;
_Bool g_bLowVolFlag = 0;
_Bool g_bOpenVolFlag = 0;

_Bool g_bWaitInputStable = 0;
_Bool g_bCmdDelayFlag = 0;
...
void __attribute__((picinterrupt(("")))) INTERRUPT_InterruptManager(void)
{
    ...
    if (PIR3bits.RCIF == 1)
    {
        ...
        if (Rx_Length < sizeof (Rx_Buffer_ISR))
        {
            ...
            Rx_Length++;
            g_uRs485TimeOut = 100 //串口接受数据超时时间;
        }
        else
        {
            Rx_Length = 0;
    ...
    if (PIR0bits.TMR0IF == 1) //1ms 定时器计数标志
    {
        ...
        if (RB7 == 0)
        {
            ...
            {
                g_bRemoveProtectionFlag = 1;
            }
        }
        else
        {
            g_bRemoveProtectionFlag = 0;
            g_uDebounceUpTime = 0;
        }
