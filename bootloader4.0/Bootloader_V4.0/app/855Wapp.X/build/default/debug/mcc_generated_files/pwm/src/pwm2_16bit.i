...
# 110 "mcc_generated_files/pwm/src/../pwm2_16bit.h"
...
void __attribute__((picinterrupt(("irq(PWM2),base(12296)")))) PWM2_16BIT_PWMI_ISR()
{
    PIR5bits.PWM2IF = 0;
...
void __attribute__((picinterrupt(("irq(PWM2PR),base(12296)")))) PWM2_16BIT_PWMPI_ISR()
{
    PIR5bits.PWM2PIF = 0;
