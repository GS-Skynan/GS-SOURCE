...
# 155 "mcc_generated_files/adc/src/../adc.h"
...
# 220 "mcc_generated_files/adc/src/../adc.h"
...
# 286 "mcc_generated_files/adc/src/../adc.h"
_Bool ADC_HasAccumulatorOverflowed(void);
# 295 "mcc_generated_files/adc/src/../adc.h"
...
# 368 "mcc_generated_files/adc/src/../adc.h"
...
# 425 "mcc_generated_files/adc/src/../adc.h"
...
# 442 "mcc_generated_files/adc/src/../adc.h"
...
# 475 "mcc_generated_files/adc/src/../adc.h"
_Bool ADC_IsConversionDoneInterruptFlagSet(void);
# 484 "mcc_generated_files/adc/src/../adc.h"
...
# 43 "mcc_generated_files/adc/src/adc.c" 2
...
void __attribute__((picinterrupt(("irq(AD),base(12296)")))) ADC_ISR(void)
{
    PIR1bits.ADIF = 0;
...
void __attribute__((picinterrupt(("irq(ADT),base(12296)")))) ADC_ThresholdISR(void)
{
    PIR2bits.ADTIF = 0;
...
{
    adc_result_t result[20], temp, average = 0;
    int i, j,k;

    for(k = 0; k < 20; k++) {

        result[k] = ADC_ChannelSelectAndConvert(channel);
...
{
    adc_result_t result[12], temp, average = 0;
    int i, j,k;
