...
# 110 "mcc_generated_files/pwm/src/../pwm3_16bit.h"
...
void __attribute__((picinterrupt(("irq(PWM3),base(12296)")))) PWM3_16BIT_PWMI_ISR()
{
    PIR7bits.PWM3IF = 0;
...
void __attribute__((picinterrupt(("irq(PWM3PR),base(12296)")))) PWM3_16BIT_PWMPI_ISR()
{
    PIR7bits.PWM3PIF = 0;
