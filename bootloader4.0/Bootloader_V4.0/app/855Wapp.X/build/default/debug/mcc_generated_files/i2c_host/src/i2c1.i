...
void __attribute__((picinterrupt(("irq(I2C1), base(12296)")))) I2C1_ISR(void)
{
...
void __attribute__((picinterrupt(("irq(I2C1E), base(12296)")))) I2C1_ERROR_ISR(void)
{
    if (I2C1_IsBusCol())
    {
...
void __attribute__((picinterrupt(("irq(I2C1RX), base(12296)")))) I2C1_RX_ISR(void)
{
    *i2c1Status.readPtr = I2C1_DataReceive();
    i2c1Status.readPtr++;
}

void __attribute__((picinterrupt(("irq(I2C1TX), base(12296)")))) I2C1_TX_ISR(void)
{
